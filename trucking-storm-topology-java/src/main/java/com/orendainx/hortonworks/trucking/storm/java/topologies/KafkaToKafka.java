...
//        (r) -> new Values("EnrichedTruckData", r.value()), new Fields("dataType", "data"));
//    byTopic.forTopic(trafficTopic, (r) -> new Values("TrafficData", r.value()), new Fields("dataType", "data"));
